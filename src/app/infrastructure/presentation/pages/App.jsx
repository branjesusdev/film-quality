  ...
  return (
    <div className='relative z-10 min-h-screen'>
      <div className='overflow-hidden'>
        <div className="contrast-50 absolute left-0 h-full w-[100%] max-w-none object-cover object-center bg-no-repeat cursor-none pointer-events-none bg-[url('/backgrounds/bg-4-000fae5e.png')]"></div>
      </div>
      <Header/>

      <main className='max-w-7xl mx-auto mt-[5rem] flex flex-col md:gap-4 xl:gap-6'>
        <div>
          <CategoriesMovies/>
        </div>
        <div className='grid grid-cols-2 md:gap-4 xl:gap-6'>
          <PopularMovies/>
          <UpcomingMovies/>
        </div>
